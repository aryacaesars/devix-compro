  ...
  return (
    <div
      className={`
        ...
        hover:shadow-2xl hover:bg-gradient-to-b hover:from-[#0454BE] hover:to-blue-500 hover:text-white
        dark:hover:from-blue-900 dark:hover:to-blue-700
      `}
    >
      {isPopular && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#0454BE] text-white text-xs font-bold px-6 py-1 rounded-full shadow-lg z-10 tracking-wide border-2 border-white">
          Populer
        </div>
      )}
      <h3 className="text-2xl md:text-3xl font-extrabold mb-6 text-[#0454BE] dark:text-blue-700 group-hover:text-white transition-colors duration-500 text-center">
        {name}
      </h3>
      ...
      <Link
        ...
        className="
          ...
          bg-[#0454BE] dark:bg-blue-700 shadow-md
          group-hover:bg-white group-hover:text-[#0454BE] group-hover:border-[#0454BE]
